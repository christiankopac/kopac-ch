...
This page demonstrates beautifully styled quotes.
...
{{< quote cite="*Alan Kay*" >}}
*The best way to predict the future is to invent it. This simple statement captures the essence of innovation and forward-thinking.*
{{< /quote >}}
